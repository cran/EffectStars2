...
#' @references Tutz, G. and Schauberger, G. (2013): \emph{Visualization of
#' Categorical Response Models - from Data Glyphs to Parameter Glyphs}, Journal
#' of Computational and Graphical Statistics, 22(1), 156--177
#' @keywords package
NULL
